...
def serialize_skill(skill: Skill) -> dict:
    ...
    return {
        ...
        "tags": skill.tags,
        "runtime_requirements": skill.runtime_requirements or [],
        "install_guidance": skill.install_guidance or [],
        "security_review": skill.security_review or [],
        "docs_sections": skill.docs_sections or [],
